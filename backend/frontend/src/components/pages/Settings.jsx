  ...
  return (
    <div className="max-w-5xl mx-auto my-20 px-4">
                  ...
                  {[
                    ...
                    <label key={size.value} className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        className="w-4 h-4 text-blue-600"
                      />
                      <span className={`text-gray-700 dark:text-gray-300 ${size.size}`}>
      ...
      <div className="flex justify-center gap-4 mt-10 pt-6 border-t border-gray-200 dark:border-gray-700">
        <button 
          onClick={handleReset} 
          className="px-8 py-3 bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 rounded-lg text-base font-medium text-gray-700 dark:text-gray-300 cursor-pointer transition-all hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-400"
        >
